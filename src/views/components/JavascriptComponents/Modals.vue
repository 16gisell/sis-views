<template>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <modal :show.sync="modals.modal1" body-classes="p-0" modal-classes="modal-dialog-centered modal-lg">
                <card type="secondary" shadow
                    ...
                    <template>
                        <div class="text-muted text-center mb-3">
                            <h6>Formulario registro de usuarios</h6>
                        </div>
                    </template>
                    <template>
                        <div class="text-center text-muted mb-4">
                            <small>Asegurece de tener los datos correctos para una mejor experiencia</small>
                        </div>
        ...
        methods: {
            ...
            validarSubmit() { //llamada principal submit
                ...
                if (!this.validarForm()) {
                    ...
                    const data = {
                        usuario: {
                            nombre: this.nombre == null ? "Empresa": this.nombre,
                            razon_social: this.razon_social== null ? "Persona natural": this.razon_social,
                            correo: this.correo,
                            telefono_principal: this.tlf_principal,
                            telefono_secundario: this.tlf_secundario == null ? "00000000000" : this.tlf_secundario,
            ...
            registrar(data) {
                ...
                const crear = clienteService.postCliente(datos);
                crear.then(data => {                                    
                    if(data.status == 200){
                        this.send = true,
            ...
            refrechTotalData() {
                ...
                this.fecha_emi=null
                this.fecha_ven=null
                this.tlf_secundario=null
                this.tlf_principal=null
...
<style>
.error-input {
  box-shadow:0 1px 3px #f5365ce8, 0 1px 0 rgba(0, 0, 0, 0.02) !important;
}
.text_error{
    color: #f5365ce8;
}
