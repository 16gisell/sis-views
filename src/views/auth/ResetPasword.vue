                    ...
                    <card type="secondary" shadow header-classes="bg-white pb-5" body-classes="px-lg-5 py-lg-5" class="border-0">
                        <template>
                            <div class="text-muted text-center mb-3">
                                <h4 class="mb-1">Recuperacion de Password!!</h4>
                            </div>
                        ...
                        <template>
                            <div class="text-center text-muted mb-4">
                                <small>Indica tu correo y se enviara un enlace para tu recuperacion!!</small>
                            </div>
                            <form @submit.prevent="LoginUser">
                                <base-input alternative type="email" class="mb-3" placeholder="Correo" addon-left-icon="ni ni-email-83" required v-model="correo"></base-input>
